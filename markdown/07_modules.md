...
![shopping lists](assets/images/modules/legolists.png)
...
`isPrefixOf` search for a sublist at the beginning and at the end of a list, respectively.
...
`map` work much like their list equivalents.
